...
## Verification
- [ ] 1a: `bun test src/lib/__tests__/retrieval.test.ts` — should exit 0 (36 tests)
- [ ] 1b: `bun test src/lib/__tests__/ollama.test.ts` — should exit 0 (71 tests)
- [ ] 1c: `bun test src/lib/__tests__/prompt-builder.test.ts` — should exit 0 (62 tests)
- [ ] 1d: `bun test src/lib/__tests__/auth.test.ts` — should exit 0 (39 tests)
- [ ] 1e: `bun test src/lib/__tests__/event-bus.test.ts` — should exit 0 (30 tests)
- [ ] 1f: `bun test src/lib/jobs/__tests__/job-processor.test.ts` — should exit 0 (44 tests)
- [ ] 2a: `npm run build` — should exit 0 (build compiles clean)
