...
## Corpus Check
- 44 files · ~24,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 523 nodes · 598 edges · 55 communities (46 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53b813ca`
...
Cohesion: 0.08
Nodes (34): DELETE(), GET(), PUT(), authenticateUser(), AuthToken, createUser(), generateToken(), getUserById() (+26 more)
...
Cohesion: 0.06
Nodes (31): 3. Scene State Layer, Archival Thresholds, Canon Enforcement, Canon Layers, Chat Memory Structure, code:yaml (scene_state:), code:yaml (message:), code:yaml (message_summary:) (+23 more)
...
Cohesion: 0.23
Nodes (9): buildPrompt(), POST(), OLLAMA_CONFIG, checkOllamaConnection(), generateTextStream(), isOllamaAvailable(), OllamaEmbedRequest, OllamaEmbedResponse (+1 more)
...
Cohesion: 0.25
Nodes (8): 2. Timeline Layer, code:yaml (turn_mode: freeform    # freeform or ordered), Group Session API, Group Session Flow, Group Sessions, Real-Time Sync, Session Types, Turn Management (Optional)
...
Cohesion: 0.29
Nodes (7): Backlink Format, code:yaml (narrative_state:), code:text (Universe/), code:markdown (---), Link Types, Narrative Thread Tracking, Obsidian-Style Storage
...
Cohesion: 0.33
Nodes (6): 1. Universe Layer, 4. Relationship Memory, code:yaml (relationship:), code:block5 (Session: "The Eastern Ruins Expedition"), code:yaml (universe:), Group Session Architecture
...
- **Why does `Roleplay-Engine: Full Implementation Plan` connect `Community 9` to `Community 33`, `Community 34`, `Community 3`, `Community 5`, `Community 15`, `Community 16`, `Community 17`, `Community 21`, `Community 22`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `5. Narrative Systems` connect `Community 3` to `Community 9`, `Community 6`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Text-to-Speech (TTS)` connect `Community 4` to `Community 8`?**
