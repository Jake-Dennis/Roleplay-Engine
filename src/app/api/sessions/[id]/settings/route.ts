...
export async function PUT(
  ...
  if (body.temperature !== undefined) settings.temperature = body.temperature;
  if (body.topP !== undefined) settings.topP = body.topP;
  if (body.numCtx !== undefined) settings.numCtx = body.numCtx;
